...
longest_time=6000
layers=[6,6]
attribute={'food':0.5,'boundary':0,'move':-0.05,'static':-0.05}#food boundry move static
# 评估当前参数的质量
...
if __name__ == "__main__":
    ...
    param_size = 1000   #最大参数尺寸，比agent的参数量大就行
    ...
    for epoch in range(epochs):
        ...
        pickle.dump(sigma, open("sigma.pkl", "wb"))
        pickle.dump(np.mean(score_list), open("score.pkl", "wb"))
